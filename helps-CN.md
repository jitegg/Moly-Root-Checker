...
- 日常使用建议关闭 USB 调试，仅在需要时开启
- 若检测到 USB 调试开启，可在开发者选项中关闭
- 刷机或使用 ADB 命令后，及时关闭 USB 调试

---

## 9. Soter 密钥状态

- Soter 密钥依赖 TEE 环境，若 TEE 异常则 Soter 无法正常工作
- 刷机后若发现微信支付异常，可尝试重刷官方完整包
- 部分设备刷机后 SoterService 被精简，需从官方 ROM 中恢复
- 建议刷机前备份 Soter 相关文件（如 /data/data/com.tencent.mm/soter）
